...
$(function() {
    (function(sorcWeb) {
        ...
        mod.setSelectors = function() {
            ...
            mod.captchaInput = mod.module.find('input[name="captcha[input]"]');
            mod.captchaId = mod.module.find('input[name="captcha[id]"]');
                ...
                click : function(e) {
                    ...
                    if (mod.validateForm()) {
                        var postData = {
                            ...
                            csrf: mod.csrf.val(),
                            captcha: { id: mod.vars.captchaId, input: mod.vars.captchaValue }
                        };
        ...
        mod.validateForm = function() {
            ...
            mod.vars.captchaId = mod.captchaId.val();
            mod.vars.captchaValue = mod.captchaInput.val();
            mod.rows.eq(4).toggleClass('error', !mod.vars.captchaValue);
            isValid = isValid && mod.vars.captchaValue;
        ...
        mod.processErrors = function(errors) {
            ...
            var captchaRow = mod.rows.eq(4);
            captchaRow.toggleClass('error', errors.hasOwnProperty('captcha'));

            if (errors.captcha) {
                captchaRow.find('.error-message').html('Incorrect verification value.');
            }
